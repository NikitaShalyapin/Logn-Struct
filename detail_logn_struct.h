...
#ifndef TESTLIBDETAIL_DETAIL_LOGN_STRUCT_H
#define TESTLIBDETAIL_DETAIL_LOGN_STRUCT_H
...
namespace detail
{
    ...
    template< class T >
    struct logn_struct_key_of_value
    {
    ...
    template< class T >
    struct logn_struct_key_compare
    {
    ...
    struct logn_struct_node_base : public _Rb_tree_node_base_template<logn_struct_node_base<_Val, _SizeOfValue> >
    {
        typedef _Rb_tree_node_base_template<logn_struct_node_base> _Template_type;
        size_t  _M_size;

        logn_struct_node_base()
                : _M_size((size_t)-1)   /* -1 should be safety for header only */
        {
        }

        static void _Rb_clone_node(logn_struct_node_base *target,
                                   logn_struct_node_base const *source)
        {
        ...
        static void
        _Rb_tree_rotate_left(logn_struct_node_base* const __x,
                             typename _Template_type::_Base_ptr_proxy & __root)
        {
            logn_struct_node_base* const __y = __x->_M_right;
        ...
        static void
        _Rb_tree_rotate_right(logn_struct_node_base* const __x,
                              typename _Template_type::_Base_ptr_proxy & __root)
        {
            logn_struct_node_base* const __y = __x->_M_left;
        ...
        static void
        _Rb_tree_adjust_node_size(logn_struct_node_base* __x, /* Element to adjust size */
                                  logn_struct_node_base& __header,
                                  size_t             add_size,
                                  size_t             sub_size)
        {
            if(add_size == sub_size)
                return;
            for (logn_struct_node_base *__parent = __x;
                 __parent != &__header;
        ...
        _Rb_tree_on_insert(const bool __insert_left,
                           logn_struct_node_base* __x, /* New inserted element */
                           logn_struct_node_base* __p, /* Parent of element x */
                           logn_struct_node_base& __header)
        {
            _Template_type::_Rb_tree_on_insert(__insert_left, __x, __p, __header);
            _Val &value = static_cast<_Rb_tree_node<_Val, logn_struct_node_base> *>(__x)->_M_value_field;
        ...
        static void
        _Rb_tree_on_erase(logn_struct_node_base* const __z,  /* Element to be erased */
                          logn_struct_node_base* __y,        /* Element to replace the position of __z */
                          logn_struct_node_base* __x,        /* Origal right element of __y */
                          logn_struct_node_base* __x_parent, /* Virtual parent of __x */
                          logn_struct_node_base& __header)
        {
            _Template_type::_Rb_tree_on_erase(__z, __y, __x, __x_parent, __header);
            _Val &value_z = static_cast<_Rb_tree_node<_Val, logn_struct_node_base> *>(__z)->_M_value_field;
            size_t size_z = _SizeOfValue()(value_z);

            _Val &value_y = static_cast<_Rb_tree_node<_Val, logn_struct_node_base> *>(__y)->_M_value_field;
            size_t size_y = _SizeOfValue()(value_y);

            __y->_M_size = __z->_M_size;

            logn_struct_node_base *__parent;
    ...
    struct logn_struct_const_iterator;

    template<typename _Val, typename _Rb_tree_node_base>
    struct logn_struct_iterator
    {
    protected:
        typedef logn_struct_const_iterator<_Val, _Rb_tree_node_base> const_iterator;
        typedef detail::_Rb_tree_iterator<_Val, _Rb_tree_node_base>  _Rb_tree_iterator;
    public:
        ...
        typedef logn_struct_iterator<_Val, _Rb_tree_node_base> _Self;
        typedef typename _Rb_tree_iterator::_Base_ptr      _Base_ptr;
        typedef typename _Rb_tree_iterator::_Link_type     _Link_type;

        logn_struct_iterator()
                : _M_itr()
        {
        }

        explicit
        logn_struct_iterator(_Rb_tree_iterator __x)
                : _M_itr(__x)
        {
        }

        explicit
        logn_struct_iterator(typename _Rb_tree_iterator::_Link_type __x)
                : _M_itr(__x)
        {
        }
    ...
    {
    protected:
        typedef logn_struct_iterator<_Val, _Rb_tree_node_base>            iterator;
        typedef detail::_Rb_tree_const_iterator<_Val, _Rb_tree_node_base> _Rb_tree_const_iterator;
    public:
        ...
        typedef logn_struct_const_iterator<_Val, _Rb_tree_node_base>  _Self;
        ...
        logn_struct_const_iterator()
                : _M_itr()
        {
        }

        explicit
        logn_struct_const_iterator(_Rb_tree_const_iterator __x)
                : _M_itr(__x)
        {
        }

        explicit
        logn_struct_const_iterator(typename _Rb_tree_const_iterator::_Link_type __x)
                : _M_itr(__x)
        {
        }

        logn_struct_const_iterator(const iterator& __it)
                : _M_itr(__it._M_itr)
        {
        }
    ...
    template<typename _Val, typename _Rb_tree_node_base>
    inline bool
    operator==(const logn_struct_iterator<_Val, _Rb_tree_node_base>& __x,
               const logn_struct_const_iterator<_Val, _Rb_tree_node_base>& __y)
    ...
    template<typename _Val, typename _SizeOfValue = logn_struct_size<_Val>, typename _Alloc = std::allocator<_Val> >
    class logn_struct
            : protected _Rb_tree<_Val, _Val, logn_struct_key_of_value<_Val>, logn_struct_key_compare<_Val>, _Alloc, logn_struct_node_base<_Val, _SizeOfValue> >
    {
    protected:
        typedef _Rb_tree
                <
                        _Val,
                        _Val,
                        logn_struct_key_of_value<_Val>,
                        logn_struct_key_compare<_Val>,
                        _Alloc,
                        logn_struct_node_base<_Val, _SizeOfValue>
                >                                            _Rep_type;
    ...
    public:
        typedef logn_struct_iterator<value_type, typename _Rep_type::_Base_type>       iterator;
        typedef logn_struct_const_iterator<value_type, typename _Rep_type::_Base_type> const_iterator;
    ...
    public:
        ...
        explicit logn_struct(const allocator_type& __a)
                : _Rep_type(__a)
        { }

        explicit logn_struct(size_type __count)
        {
            insert(begin(), __count, value_type());
        }

        logn_struct(size_type __count, const value_type &__val)
        {
            insert(begin(), __count, __val);
        }

        logn_struct(size_type __count, const value_type &__val, const allocator_type& __a)
                : _Rep_type(__a)
        {
            insert(begin(), __count, __val);
        }
        ...
        logn_struct(_InputIterator __first, _InputIterator __last)
        {
            insert(begin(), __first, __last);
        }

        template<typename _InputIterator>
        logn_struct(_InputIterator __first, _InputIterator __last, const allocator_type& __a)
                : _Rep_type(__a)
        {
            insert(begin(), __first, __last);
        }

        logn_struct(const logn_struct<_Val, _SizeOfValue, _Alloc>& __x)
    ...
    public:
        ...
        void
        set(iterator __position, const value_type& __v);
        ...
        iterator
        remove(iterator __position);

        const_iterator
        remove(const_iterator __position);

        iterator
        remove(iterator __first, iterator __last);

        const_iterator
        remove(const_iterator __first, const_iterator __last);
...
private:
        ...
        void
        swap(logn_struct<_Val, _SizeOfValue, _Alloc>& __t);
        ...
        void
        splice(iterator __position, logn_struct &__x)
        {
            if (!__x.empty())
                splice(__position, __x, __x.begin(), __x.end());
        }
        void
        splice(iterator __position, logn_struct &right, iterator __i)
        {
            iterator __j = __i;
            ++__j;
        ...
        void
        splice(iterator __position, logn_struct &right, iterator __first, iterator __last)
        {
            while (__first != __last)
            {
    ...
    private:
        ...
        template<typename _StrictWeakOrdering>
        void
        merge(logn_struct &right, _StrictWeakOrdering comp)
        {
            splice(begin(), right);
            sort(comp);
        }
    ...
    inline bool
    operator==(const logn_struct<_Val, _SizeOfValue, _Alloc>& __x,
               const logn_struct<_Val, _SizeOfValue, _Alloc>& __y)
    {
    ...
    template<typename _Val, typename _SizeOfValue, typename _Alloc>
    inline void
    swap(logn_struct<_Val, _SizeOfValue, _Alloc>& __x,
         logn_struct<_Val, _SizeOfValue, _Alloc>& __y)
    { __x.swap(__y); }

    template<typename _Val, typename _SizeOfValue, typename _Alloc>
    inline void
    logn_struct<_Val, _SizeOfValue, _Alloc>::
    swap(logn_struct<_Val, _SizeOfValue, _Alloc>& __t)
    {
    ...
    template<typename _Val, typename _SizeOfValue, typename _Alloc>
    inline typename logn_struct<_Val, _SizeOfValue, _Alloc>::iterator
    logn_struct<_Val, _SizeOfValue, _Alloc>::
    ...
    template<typename _Val, typename _SizeOfValue, typename _Alloc>
    inline typename logn_struct<_Val, _SizeOfValue, _Alloc>::const_iterator
    logn_struct<_Val, _SizeOfValue, _Alloc>::
    remove(const_iterator __position)
    {
    ...
    remove(iterator __first, iterator __last)
    {
        typename logn_struct<_Val, _SizeOfValue, _Alloc>::iterator itr = end();
    ...
    remove(const_iterator __first, const_iterator __last)
    {
        typename logn_struct<_Val, _SizeOfValue, _Alloc>::const_iterator itr = end();
        if (__first == begin() && __last == end())
            clear();
        else
            while (__first != __last)
...
#endif //TESTLIBDETAIL_DETAIL_LOGN_STRUCT_H
